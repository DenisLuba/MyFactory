...
using MyFactory.MauiClient.Services.AuthServices;
...
using MyFactory.MauiClient.Services.UsersServices;
...
#region AddMyFactoryServices Method
	private static MauiAppBuilder AddMyFactoryServices(this MauiAppBuilder builder)
	{
		...
		builder.Services.AddSingleton<IShiftPlansService, ShiftPlansService>();
		...
		builder.Services.AddSingleton<IMaterialTransfersService, MaterialTransfersService>();
