    ...
    public partial class AppShell : Shell
    {
        public AppShell()
        {
            ...
            var routes = new (string Name, Type PageType)[]
            {
                ...
                (nameof(DistributeFinishedGoodsPage), typeof(DistributeFinishedGoodsPage)),
                ...
                (nameof(ProductSpecificationPage), typeof(ProductSpecificationPage)),
                (nameof(ProductCostsPage), typeof(ProductCostsPage)),
                (nameof(ProductStocksPage), typeof(ProductStocksPage)),
                (nameof(ProductsListPage), typeof(ProductsListPage)),
                (nameof(ProductTypesPage), typeof(ProductTypesPage)),
                ...
                (nameof(OrderCreatePage), typeof(OrderCreatePage)),
                (nameof(OrderUpdatePage), typeof(OrderUpdatePage)),
            };
