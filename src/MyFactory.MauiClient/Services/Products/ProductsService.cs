...
public sealed class ProductsService : IProductsService
{
    ...
    public async Task<ListResponse<ProductListItemResponse>?> GetListAsync(
        ...
        Guid? fromId = null)
    {
        ...
        return await _httpClient.GetFromJsonAsync <ListResponse<ProductListItemResponse>>(path);
    }
