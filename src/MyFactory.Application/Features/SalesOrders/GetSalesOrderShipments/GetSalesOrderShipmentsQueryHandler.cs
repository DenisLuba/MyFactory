       ...
       CancellationToken cancellationToken)
    {
        var query =
            ...
            join fg in _db.FinishedGoods.AsNoTracking()
                ...
                equals new { fg.ProductId, WarehouseId = (Guid?)fg.WarehouseId }
            ...
            join warehouse in _db.Warehouses.AsNoTracking()
                on fgm.ToWarehouseId equals (Guid?)warehouse.Id
            ...
            where soItem.SalesOrderId == request.SalesOrderId
                && fgm.MovementType == FinishedGoodsMovementType.Shipment
                && fgm.ToWarehouseId != null
