...
public sealed class RejectPurchaseRequestCommandHandler : IRequestHandler<RejectPurchaseRequestCommand, PurchaseRequestDto>
{
    private readonly IApplicationDbContext _context;

    public RejectPurchaseRequestCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PurchaseRequestDto> Handle(RejectPurchaseRequestCommand request, CancellationToken cancellationToken)
    {
