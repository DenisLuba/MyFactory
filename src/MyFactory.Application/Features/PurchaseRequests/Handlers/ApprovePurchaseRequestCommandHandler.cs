...
public sealed class ApprovePurchaseRequestCommandHandler : IRequestHandler<ApprovePurchaseRequestCommand, PurchaseRequestDto>
{
    private readonly IApplicationDbContext _context;

    public ApprovePurchaseRequestCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PurchaseRequestDto> Handle(ApprovePurchaseRequestCommand request, CancellationToken cancellationToken)
    {
