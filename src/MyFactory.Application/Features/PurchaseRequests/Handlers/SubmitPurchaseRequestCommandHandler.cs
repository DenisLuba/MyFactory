...
public sealed class SubmitPurchaseRequestCommandHandler : IRequestHandler<SubmitPurchaseRequestCommand, PurchaseRequestDto>
{
    private readonly IApplicationDbContext _context;

    public SubmitPurchaseRequestCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PurchaseRequestDto> Handle(SubmitPurchaseRequestCommand request, CancellationToken cancellationToken)
    {
