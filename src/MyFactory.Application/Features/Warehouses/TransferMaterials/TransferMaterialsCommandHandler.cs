    ...
    : IRequestHandler<TransferMaterialsCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (fromWarehouse.Type is WarehouseType.FinishedGoods)
            throw new DomainApplicationException("Mistake. Moving materials from the goods warehouse.");
        ...
        if (toWarehouse.Type is WarehouseType.FinishedGoods)
            throw new DomainApplicationException("Mistake. Moving materials to the goods warehouse.");
