...
public class ApplicationDbContext : DbContext, IApplicationDbContext
{
    ...
    public DbSet<MaterialImageEntity> MaterialImages { get; set; } = default!;
    ...
    public DbSet<ProductTypeEntity> ProductTypes { get; set; } = default!;
    ...
    public DbSet<ProductionOrderDepartmentEmployeeEntity> ProductionOrderDepartmentEmployees { get; set; } = default!;
