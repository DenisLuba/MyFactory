...
public class PayrollRulesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetList()
    {
        ...
        var response = dtos
            .Select(x => new PayrollRuleResponse(x.Id, x.Name, x.EffectiveFrom, x.PremiumPercent, x.Description))
            .ToList();
        return Ok(response);
    }
    ...
    public async Task<IActionResult> GetDetails(Guid id)
    {
        ...
        return Ok(new PayrollRuleResponse(dto.Id, dto.Name, dto.EffectiveFrom, dto.PremiumPercent, dto.Description));
    }
    ...
    {
        var id = await _mediator.Send(new CreatePayrollRuleCommand(req.Name, req.EffectiveFrom, req.PremiumPercent, req.Description));
    ...
    {
        await _mediator.Send(new UpdatePayrollRuleCommand(req.Name, id, req.EffectiveFrom, req.PremiumPercent, req.Description));
        return NoContent();
    }
