...
public class FinanceController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ListResponse<PayrollAccrualListItemResponse>), StatusCodes.Status200OK)]
    ...
    {
        var dto = await _mediator.Send(new GetPayrollAccrualsQuery(
            From: from,
            To: to,
        ...
        var response = new ListResponse<PayrollAccrualListItemResponse>(
            Items: [.. dto.Items.Select(x => new PayrollAccrualListItemResponse(
                x.EmployeeId,
                x.EmployeeName,
                x.TotalHours,
                x.QtyPlanned,
