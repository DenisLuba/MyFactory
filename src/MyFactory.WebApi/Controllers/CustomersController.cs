...
using MyFactory.Application.Features.Customers.ActivateCustomer;
...
public class CustomersController : ControllerBase
{
    ...
    // -------------------------
    [HttpGet]
    [ProducesResponseType(typeof(ListResponse<CustomerListItemResponse>), StatusCodes.Status200OK)]
        ...
        [FromQuery] bool? isActive = null)
    {
        ...
        var response = new ListResponse<CustomerListItemResponse>(
            Items: [.. result.Items
