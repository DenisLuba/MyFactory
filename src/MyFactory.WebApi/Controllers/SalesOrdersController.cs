...
public class SalesOrdersController : ControllerBase
{
    ...
    // -------------------------
    [HttpGet]
    [ProducesResponseType(typeof(ListResponse<SalesOrderListItemResponse>), StatusCodes.Status200OK)]
    ...
    )
    {
        ...
        var response = new ListResponse<SalesOrderListItemResponse>(
            Items: [.. dtos.Items
                .Select(c => new SalesOrderListItemResponse(
                    Id: c.Id,
    ...
    private static SalesOrderStatus? GetStatusFromString(string? status) => status switch
    {
        "New" => SalesOrderStatus.New,
        "Confirmed" => SalesOrderStatus.Confirmed,
        "PartiallyFulfilled" => SalesOrderStatus.PartiallyFulfilled,
