...
using MyFactory.Application.Features.Employees.GetEmployee;
...
public class EmployeesController : ControllerBase
{
    ...
    // -------------------------
    [HttpGet]
    [ProducesResponseType(typeof(ListResponse<EmployeeListItemResponse>), StatusCodes.Status200OK)]
    ...
    public async Task<IActionResult> GetList(
        ...
        [FromQuery] bool? canCut = null,
        [FromQuery] bool? canSew = null,
        [FromQuery] bool? canPackage = null,
        [FromQuery] ICollection<Guid>? exceptEmployeeIds = null)
    {
        var dto = await _mediator.Send(new GetEmployeesQuery(
            FullName: searchName,
            SortBy: sortBy,
            SortDesc: sortDesc,
            Skip: skip,
        ...
        var response = new ListResponse<EmployeeListItemResponse>(
            Items: [.. dto.Items
