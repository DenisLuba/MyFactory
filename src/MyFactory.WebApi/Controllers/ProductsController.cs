...
public class ProductsController : ControllerBase
{
    ...
    // -------------------------
    [HttpGet]
    [ProducesResponseType(typeof(ListResponse<ProductListItemResponse>), StatusCodes.Status200OK)]
    ...
    {
        var dto = await _mediator.Send(new GetProductsQuery(
        ...
        var response = new ListResponse<ProductListItemResponse>(
            Items: [.. dto.Items
