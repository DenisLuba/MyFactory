...
public class DepartmentEntity : ActivatableEntity
{
    ...
    public IReadOnlyCollection<ProductionOrderDepartmentEmployeeEntity> ProductionOrderDepartmentEmployees { get; private set; } = new List<ProductionOrderDepartmentEmployeeEntity>();
...
public class EmployeeEntity : ActivatableEntity
{
    ...
    public bool CanWorkAtStage(ProductionStage stage) => stage switch
    {
        ProductionStage.Cutting => Position?.CanCut == true,
        ProductionStage.Sewing => Position?.CanSew == true,
        ProductionStage.Packaging => Position?.CanPackage == true,
        _ => false
    };
