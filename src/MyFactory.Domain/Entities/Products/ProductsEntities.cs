...
public class ProductEntity : AuditableEntity
{
    ...
    public ICollection<ProductDepartmentCostEntity> ProductDepartmentCosts { get; private set; } = new List<ProductDepartmentCostEntity>();
    public ICollection<ProductMaterialEntity> ProductMaterials { get; private set; } = new List<ProductMaterialEntity>();
    public ICollection<FinishedGoodsEntity> FinishedGoods { get; private set; } = new List<FinishedGoodsEntity>();
    public ICollection<WarehouseProductEntity> WarehouseProducts { get; private set; } = new List<WarehouseProductEntity>();
    public ICollection<FinishedGoodsMovementItemEntity> FinishedGoodsMovementItems { get; private set; } = new List<FinishedGoodsMovementItemEntity>();
    public ICollection<ShipmentItemEntity> ShipmentItems { get; private set; } = new List<ShipmentItemEntity>();
    public ICollection<FinishedGoodsStockEntity> FinishedGoodsStocks { get; private set; } = new List<FinishedGoodsStockEntity>();
    public ICollection<ShipmentReturnItemEntity> ShipmentReturnItems { get; private set; } = new List<ShipmentReturnItemEntity>();
    public ICollection<ProductImageEntity> ProductImages { get; private set; } = new List<ProductImageEntity>();
...
public class ProductTypeEntity : BaseEntity
{
    ...
    public ProductTypeEntity(string type, string? description)
    {
        Guard.AgainstNullOrWhiteSpace(type, "Type cannot be null or empty.");
        Type = type;
        Description = description;
    }

    public void Update(string? type = null, string? description = null)
    {
        if (type is not null)
        {
            Guard.AgainstNullOrWhiteSpace(type, "Type cannot be null or empty.");
...
public class ProductMaterialEntity : BaseEntity
{
    ...
    public decimal QtyPerUnit { get; private set; } // количество материала на единицу товара
