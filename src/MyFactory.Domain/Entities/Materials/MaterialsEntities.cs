...
public class MaterialEntity : ActivatableEntity
{
    ...
    public MaterialEntity(string name, Guid materialTypeId, Guid unitId, string? color = null, string? description = null)
    {
    ...
    public void Update(string name, Guid materialTypeId, Guid unitId, string? color, string? description)
    {
        Name = name;
        MaterialTypeId = materialTypeId;
        UnitId = unitId;
...
{
    public Guid SupplierId { get; private set; }
    public decimal PurchaseNumber { get; private set; }
    ...
    public void SetPurchaseNumber(decimal purchaseNumber)
    {
        Guard.AgainstNonPositive(purchaseNumber, nameof(purchaseNumber));

        if (PurchaseNumber > 0 && PurchaseNumber != purchaseNumber)
            throw new DomainException("Purchase number is already assigned.");
...
public class MaterialImageEntity : AuditableEntity
{
    public Guid MaterialId { get; private set; }
    ...
    public MaterialImageEntity(Guid materialId, string fileName, string path, string? contentType = null, int sortOrder = 0)
    {
        Guard.AgainstEmptyGuid(materialId, "ProductId is required.");
