...
using MyFactory.Domain.OldEntities.Warehousing;
using MyFactory.Domain.OldEntities.Workshops;

namespace MyFactory.Domain.OldEntities.Production;
...
public sealed class ProductionStage : BaseEntity
{
    ...
    internal void DetachAssignment(WorkerAssignment assignment)
    {
        ...
        assignment.ProductionStage = null;
    }
}
