...
Ниже или рядом - выпадающий список типов материала с поиском.

Ниже или рядом - выпадающий список материалов с поиском. 

Ниже Entry для заполнения количества и Entry для заполнения цены (но она по умолчанию
...
# 📱 Экран 15. **Список производственных заказов**
...
# 📱 Экран 16. **Создание производственного заказа**
...
# 📱 Экран 17. Производство / Списание материалов
...
# 📱 Экран 22. Карточка участка (всегда редактируемая)
...
# 📱 Экран 24. Карточка должности (всегда в режиме редактирования)
...
## Flyout -> Финансы
- Зарплаты (табы: Начисления, Выплаты)
- Расходы (табы: Категории, Расходы)
- Прибыль и убытки (таби: Траты, Авансы, Отчёт)


# 📱 Экран 25. Начисления зарплаты
...
# 📱 Экран 26. Детализация начислений по дням
...
# 📱 Экран 27. Правила расчёта зарплаты
...
# 📱 Экран 28. Карточка правила (всегда редактируемая)
...
# 📱 Экран 30. Подотчётные авансы (список)
...
# 📱 Экран 32. Создание нового аванса
...
# 📱 Экран 33. Список финансовых отчётов
...
# 📱 Экран 34. Карточка месячного отчёта
