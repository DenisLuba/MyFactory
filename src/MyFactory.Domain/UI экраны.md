...
├── Materials/
│   ├── MaterialsListPage
│   ├── MaterialDetailsViewPage
│   └── MaterialDetailsEditPage
│
├── Suppliers/
│   ├── SuppliersListPage
│   └── SupplierDetailsPage
...
## 📱 Экран  1. Материалы — список (MaterialsListPage)
...
## 📱 Экран  2. Карточка материала (просмотр) (MaterialDetailsViewPage)
...
## 📱 Экран  3. Карточка материала (редактирование) (MaterialDetailsEditPage)
...
## 📱 Экран  4. Карточка поставщика (SuppliersListPage)
...
## 📱 Экран  5. Создание заказа поставщику (SupplierDetailsPage)
...
## 📱 Экран  6. Поставщики — список (SupplierOrderCreatePage)
...
## 📱 Экран 7. «Товары» (список) (ProductsListPage)
...
## 📱 Экран  8. «Карточка товара» (ProductDetailsPage)
...
## 📱 Экран  9. «Редактирование товара» (ProductEditPage)
...
## 📱 Экран  10. Список складов (WarehousesListPage)
...
## 📱 Экран  11. Остатки склада (WarehouseStockPage)
...
## 📱 Экран  12. Заказы (OrdersListPage)
...
## 📱 Экран  13. Карточка заказа (OrderDetailsPage)
...
## 📱 Экран  14 Заказчики (CustomersListPage)
...
## 📱 Экран  15. Карточка заказчика (CustomerDetailsPage)
...
## 📱 Экран  16. Список производственных заказов (ProductionOrdersListPage)
...
## 📱 Экран  17. Создание производственного заказа (ProductionOrderCreatePage)
...
## 📱 Экран  18. Производство / Списание материалов (MaterialConsumptionPage)
...
## 📱 Экран  19. Этапы производства (ProductionStagesPage)
...
└──Организация
    ...
    ├── Участки (Участки, Карточка участка) 
    └── Должности (Должности, Карточка должности)


## 📱 Экран  20. Список сотрудников (EmployeesListPage)
...
## 📱 Экран  21. Карточка сотрудника (EmployeeDetailsPage)
...
## 📱 Экран  22. Участки (WorkshopsPage)
...
## 📱 Экран  23. Карточка участка (всегда редактируемая) (WorkshopDetailsPage)
...
## 📱 Экран  24. Должности (PositionsListPage)
...
## 📱 Экран  25. Карточка должности (всегда в режиме редактирования) (PositionDetailsPage)
...
├── Payroll
│   ├── PayrollAccrualsPage
│   ├── PayrollDailyBreakdownPage
│   ├── PayrollRulesListPage
│   └── PayrollRuleDetailsPage
│
├── Expenses
│   ├── ExpenseCategoriesPage
│   ├── ExpensesListPage
│   ├── CashAdvancesListPage
│   ├── CashAdvanceDetailsPage
│   └── CashAdvanceCreatePage
│
└── FinancialReports
...
## 📱 Экран  26. Начисления зарплаты (PayrollAccrualsPage)
...
## 📱 Экран  27. Детализация по дням (PayrollDailyBreakdownPage)
...
## 📱 Экран  28. Правила расчёта зарплаты (PayrollRulesListPage)
...
## 📱 Экран  29. Карточка правила (всегда редактируемая) (PayrollRuleDetailsPage)
...
## 📱 Экран  30. Категории расходов (ExpenseCategoriesPage)
...
## 📱 Экран  31. Расходы (ExpensesListPage)
...
## 📱 Экран  32. Подотчётные авансы (CashAdvancesListPage)
...
## 📱 Экран  33. Карточка аванса (CashAdvanceDetailsPage)
...
## 📱 Экран  34. Создание аванса (CashAdvanceCreatePage)
...
## 📱 Экран  35. Список финансовых отчётов (FinancialReportsListPage)
...
## 📱 Экран  36. Карточка месячного отчёта (MonthlyReportDetailsPage)
...
## 📱 Экран  37. Пользователи (UsersListPage)

**Источник данных:** `USERS`, `ROLES`

```text
[Поиск по роли или логину ▼] [ Фильтр по роли ▼ ]
┌──────────────────────────────────────────────────────────┐
...
поиск по логину / роли в реальном времени
фильтр по роли из выпадающего списка    
...
```csharp
GetUsersQuery { Guid? RoleId = null, string? RoleName = null }
```
...
## 📱 Экран  38. Карточка пользователя (UserDetailsPage)
...
### Удаление роли
```text
при нажатии на роль появляется диалог:
Удалить роль 'AUDITOR'?
[ Удалить ]   [ Отмена ]
```
